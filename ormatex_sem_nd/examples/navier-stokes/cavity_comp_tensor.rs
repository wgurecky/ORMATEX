...
use edac::{advance_tensor, advance_tensor_leja, maybe_write_vtk, write_solution_csv, TensorFluidSystem};
...
fn main() {
    ...
    maybe_write_vtk(
        &problem,
        state.as_ref(),
        "target/navier_stokes_lid_driven_cavity_comp_tensor.vtu",
    );
