...
///
/// Adds streamline diffusion `tau*(vel*u')*(vel*v')` to the advective weak
/// form; the tensor flux slot folds it in as `(nu + tau*vel^2)*u' - vel*u`.
/// Tensor mirror: [`TensorKernelAdvDiffSUPG`](crate::kernels::basic::tensor::adv_diff_supg_1d::TensorKernelAdvDiffSUPG).
