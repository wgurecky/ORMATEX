...
///
/// Weak form `nu*u'*v'` (plus the `BilinearForm` fast path); the Jacobian adds
/// the `dnu` material-derivative term. Tensor mirror:
/// [`TensorKernelDiffusion`](crate::kernels::basic::tensor::diffusion_1d::TensorKernelDiffusion).
